...
function LoadBlogParts(){
	...
	sHtml += '<embed wmode="transparent" src="' + sUrl + '" quality="high" bgcolor="#FF2828" width="100%" height="100" name="' + swfTitle + '" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />';
	sHtml += '</object>';
